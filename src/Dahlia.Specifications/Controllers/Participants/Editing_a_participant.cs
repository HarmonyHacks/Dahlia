...
namespace Dahlia.Specifications.Controllers.Participants
{
    ...
    public class when_the_user_starts_to_edit_a_participant
    {
        Establish context = () =>
        {
            ...
            _controller = new ParticipantController(null, _repository, null, null);
        };
    ...
    [Subject("Editing a participant")]
    public class when_the_user_tries_to_edit_an_invalid_participant
    {
        Establish context = () =>
        {
            _repository = MockRepository.GenerateStub<IParticipantRepository>();
    ...
    [Subject("Editing a participant")]
    public class when_the_user_saves_an_edited_participant
    {
        Establish context = () =>
        {
            _viewModel = new EditParticipantViewModel
    ...
    [Subject("Editing a participant")]
    public class when_the_user_saves_an_invalid_participant
    {
        Establish context = () =>
        {
            _viewModel = new EditParticipantViewModel
